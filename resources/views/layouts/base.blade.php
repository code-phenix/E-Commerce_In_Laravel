...
<head>
	...
	{{-- for date and time from bootstrap --}}
...
<body class="home-page home-01 ">
						...
						<div class="topbar-menu right-menu">
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									...
									<a title="English" href="#"><span class="img label-before"></span>English</a>
								...
								@if(Route::has('login'))
									@auth
										@if(Auth::user()->utype==='ADM'){{-- Admin --}}
											<li class="menu-item menu-item-has-children parent" > 
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a href="{{route('admin.orders')}}" title="All Order">All Orders</a>
													</li>
										...
										@elseif(Auth::user()->utype==='SUP'){{-- Suppiler--}}
											<li class="menu-item menu-item-has-children parent" > 
												<a title="My Account" href="#">My Account({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Dashboard" href="{{ route('supplier.dashboard')}}">Dashboard</a>
													</li>
													<li class="menu-item">
														<a href="{{ route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
													</li>
										...
										@elseif(Auth::user()->utype==='NM'){{-- Network Markter --}}
											<li class="menu-item menu-item-has-children parent" > 
												<a title="My Account" href="#">My Account({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Dashboard" href="{{ route('network-markter.dashboard')}}">Dashboard</a>
													</li>
													<li class="menu-item">
														<a href="{{ route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
													</li>
	...
	{{-- tiny cloud for word like UI (29) --}}
	<script src="https://cdn.tiny.cloud/1/13a4puhgjfilwtun8z1v2b4tbe3xe6wbia2bvcsb4nzl5xkh/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
