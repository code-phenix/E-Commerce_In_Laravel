                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" wire:model="subcategory_id" wire:click="generateProductID">
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label">Product ID:</label>
                                <div class="col-md-4">
                                    <input type="text" placeholder="Product ID:" class="form-control input-md" wire:model="product_ID"/>
                                    @error('slug') <p class="text-danger">{{$message}}</p> @enderror
                                </div>
                            </div>
