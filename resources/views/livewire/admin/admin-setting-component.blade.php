                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="saveSettings">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="email" placeholder="Email" id="" class="form-control input-md" wire:model="email">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Phone" id="" class="form-control input-md" wire:model="phone">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Phone2" id="" class="form-control input-md" wire:model="phone2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Address" id="" class="form-control input-md" wire:model="address">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Map" id="" class="form-control input-md" wire:model="map">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Twitter" id="" class="form-control input-md" wire:model="twitter">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Facebook" id="" class="form-control input-md" wire:model="facebook">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Pinterest" id="" class="form-control input-md" wire:model="pinterest">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Instagram" id="" class="form-control input-md" wire:model="instagram">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Youtube" id="" class="form-control input-md" wire:model="youtube">
