                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @foreach ($product->orderItems->where('rstatus',1) as $orderItem)
                                ...
                                @endphp
                            @endforeach
                            @for($iterI=1;$iterI<=5;$iterI++)
                                @if($iterI<=$avgrating)
                                <i class="fa fa-star" aria-hidden="true"></i>
                                @else
                                    {{-- <i class="fa fa-star" style="color: gray" aria-hidden="true"></i> --}}
                                    <i class='fa fa-star' style='color: rgb(211, 209, 209)'></i>
                                @endif
                        ...
                        <div>
                            @foreach ($product->attributeValues->unique('product_attribute_id') as $attribute_value)
                                <div class="row" style="margin-top: 20px">
                                    ...
                                    <div class="col-xs-10">
                                        <select name="" id="" class="form-control" style="width: 200px" wire:model="shop_attribute.{{$attribute_value->productAttribute->name}}">
