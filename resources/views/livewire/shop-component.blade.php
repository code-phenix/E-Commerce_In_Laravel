                                ...
                                @if (count($category->subCategories))
                                    ...
                                    <ul class="sub-cate">
                                        ...
                                        <li class="category-item">
                                            <a href="{{route('product.category',['category_slug'=>$category->slug,'subcategory_slug'=>$subcategory->slug])}}" class="cat-link"><i class="fa fa-caret-right"></i> {{$subcategory->name}}</a>
                                        </li>
